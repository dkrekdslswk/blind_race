        ...
        <div class="modal-content" >
            ...
            <div class="modal-body" style="margin: 0; padding:0;">
                ...
                <div class="answer" style="padding: 5px 5px 5px 5px">
                    <input type="text" placeholder="내용을 입력하세요." id="teachersFeedback" name="contents" style="width: 100%;height:120px;"></input>
                </div>
                ...
                <div class="images" style="margin: 10px;">
                    ...
                    <script type="text/javascript">
                        ...
                        $('.request_date').text("날짜 : " + d.getFullYear() +"-"+ d.getMonth() +"-"+ d.getDate()
                                                +" ("+d.getHours()+"시"+ d.getMonth() +"분)");
