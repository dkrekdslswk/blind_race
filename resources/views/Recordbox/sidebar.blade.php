        ...
        <div class="modal-dialog" role="document" style="width: 1200px">
            ...
            <div class="modal-content studentGrade" style="padding: 10px 20px 0 20px;">
                ...
                <div class="modal-header">
                    <h3 class="modal-title" style="text-align: center;">학생 점수</h3>

                    {{--INSERT DATA 1. 날짜--}}
                    <div class="" id="modal_date" style="text-align: right;"> </div>

                    {{--INSERT DATA 2. 레이스이름과 교수님 성함--}}
                    <div class="" id="modal_RaceNameAndTeacher" style="text-align:center;"></div>

                </div>

                <div class="modal-body studentGrade" style="text-align: left;margin: 0;">
                ...
                <div class="modal-footer">
                    ...
                    {{--PAGE SPLIT 2. 모, .modal-header #modal_date달 전체 평균 점수들--}}
                    {{--INSERT DATA 4. 전체 평균 점수들--}}
                    <div class="modal_total_list" id="modal_total_grades" style="width: 30%;float: right;"> </div>
            ...
            <div class="modal-content detail" style="margin-top: 10px;padding: 10px 20px 0 20px;">
                ...
                <div class="modal-body" style="text-align: left;margin: 0;">
                    ...
                    <div class="toggle_only_students">
                    ...
                    <div class="toggle_only_wrong_answers" style="width: 100%;clear: left">
