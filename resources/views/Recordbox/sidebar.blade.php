...
<head>
    ...
    <script type="text/javascript">
        ...
        var group_id = 1;
        var chartData = "";
        var reqDateType = selectedDateType();
        ...
        $(document).on('click','.groups',function () {
            ...
            reqChartData_and_makingChart(reqGroupId , reqDateType);

        });



        //라디오버튼에 선택된 날짜타입 가져오기
        ...
        function getGroups_and_loadChart(groupId) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    reqChartData_and_makingChart(firstGroup.attr('id') , reqDateType);
